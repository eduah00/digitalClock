...
class StartPage(Frame):
    def __init__(self, parent, controller):
        ...
        clock_page = Button(self, text="Clock", command=lambda: controller.show_frame(ClockPage))
        clock_page.pack()
        timer_page = Button(self, text="Timer", command=lambda: controller.show_frame(TimerPage))
        timer_page.pack()
